...
public class ZkLock implements Watcher {
    ...
    private static final String CONNECTION_STRING = "172.16.40.2:2181";
     ...
     * @return
     */
    public boolean createPath(String path, String data, boolean needWatch) throws KeeperException, InterruptedException, KeeperException {
     ...
     */
    public void createConnection(String connectString, int sessionTimeout) throws IOException, InterruptedException, IOException {
